...
module.exports = {
  storeWorkout: function(req, res) {
    ...
    exercises.forEach((exercise) => {
      knex('history')
        .insert({sets: exercise.sets, reps: exercise.reps, weight: exercise.actualWeight})
        .then(function(data) {
          res.status(200).end('workout exercise data was successfuly stored in workout history!', data);
        });
    })
